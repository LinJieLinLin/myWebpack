...
// 表情filter
DYC.factory('emoticonService', [function() {
...
DYC.filter('emojiUnifiedToColon', ['emoticonService', function(emoticonService) {
    return function(str) {
        return emoticonService.emojiUnifiedToColon(str);
    }
}]);

DYC.filter('emojiUnifiedToCss', ['emoticonService', function(emoticonService) {
    return function(str) {
        return emoticonService.emojiUnifiedToCss(str);
    }
}]);

DYC.filter('emojiColonToUnified', ['emoticonService', function(emoticonService) {
    return function(str) {
        return emoticonService.emojiColonToUnified(str);
    }
}]);

DYC.filter('emojiColonToCss', ['emoticonService', function(emoticonService) {
    return function(str) {
